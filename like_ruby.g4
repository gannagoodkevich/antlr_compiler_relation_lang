...
int_assignment : INT_TYPE var_id=lvalue op=ASSIGN int_result
               | INT_TYPE var_id=lvalue op=( PLUS_ASSIGN | MINUS_ASSIGN | MUL_ASSIGN | DIV_ASSIGN | MOD_ASSIGN | EXP_ASSIGN ) int_result
               ;

float_assignment : FLOAT_TYPE var_id=lvalue op=ASSIGN float_result
                 | FLOAT_TYPE var_id=lvalue op=( PLUS_ASSIGN | MINUS_ASSIGN | MUL_ASSIGN | DIV_ASSIGN | MOD_ASSIGN | EXP_ASSIGN ) float_result
                 ;

string_assignment : STRING_TYPE var_id=lvalue op=ASSIGN string_result
                  | STRING_TYPE var_id=lvalue op=PLUS_ASSIGN string_result
                  ;

table_assignment : TABLE_TYPE var_id=lvalue op=ASSIGN table_result
                 ;

column_assignment : COLUMN_TYPE var_id=lvalue op=ASSIGN column_result
                  ;
